			...
			<div class="flex justify-between w-full">
				<div class="md:w-2/3">
					...
					<div class="flex items-center">
						<Tooltip
							v-if="parseInt(course.data.rating) > 0 && settingsStore.ratingsAllowed.data"
						...
						<span v-if="parseInt(course.data.rating) > 0 && settingsStore.ratingsAllowed.data" class="mx-3"
							>&middot;</span
						>
						<Tooltip
							v-if="course.data.enrollment_count && settingsStore.showEnrolledCount.data"
						...
						<span v-if="course.data.enrollment_count && settingsStore.showEnrolledCount.data" class="mx-3"
							>&middot;</span
						>
						<div v-if="settingsStore.displayInstructor.data" class="flex items-center">
							<span
								class="h-6 mr-1"
								:class="{
					...
					<CourseReviews
						v-if="settingsStore.ratingsAllowed.data"
						:courseName="course.data.name"
...
const course = createResource({
	url: 'dls.dls.utils.get_course_details',
