			...
			<div v-else class="border-r container pt-5 pb-10 px-5">
				<div class="flex flex-col md:flex-row md:items-center justify-between">
					...
					<div class="flex items-center mt-2 md:mt-0">
						...
						>
							<Button :disabled="!lesson.data.progress">
								<template #suffix>
				...
				<div class="flex items-center mt-2" v-if="settingsStore.displayInstructor.data">
					<span
						class="h-6 mr-1"
						:class="{
				...
				<div class="mt-20">
					<Discussions
						v-if="allowDiscussions && settingsStore.questionsActive.data"
						:title="'Questions'"
...
const startTimer = () => {
	timerInterval = setInterval(() => {
		timer.value++
		if (timer.value == settingsStore.lessonCompletionTime.data) {
			clearInterval(timerInterval)
			markProgress()
		}
	}, 1000)
