	...
	>
		...
		<div class="flex flex-col flex-auto p-4">
			<div class="flex items-center justify-between mb-2">
				...
				<div v-if="course.enrollments && settingsStore.showEnrolledCount.data">
				...
				<div v-if="course.rating && settingsStore.ratingsAllowed.data">
			...
			<div class="flex items-center justify-between mt-auto">
				<div v-if="settingsStore.displayInstructor.data" class="flex avatar-group overlap">
					<div
						class="h-6 mr-1"
