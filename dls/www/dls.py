...
def get_context():
	...
	favicon = (
		...
		or "/assets/dls/frontend/favicon.png"
	)
...
def get_meta(app_path, title, favicon):
	...
	description = frappe.db.get_single_value("DLS Settings", "meta_description")
	image = frappe.db.get_single_value("DLS Settings", "meta_image")
	keywords = frappe.db.get_single_value("DLS Settings", "meta_keywords")
